...
import { memo, useCallback, useState, useEffect, useMemo, createElement, forwardRef } from 'react';
...
var DisqusJSLoadMoreCommentsButton = /*#__PURE__*/ memo((props)=>{
    const { isError , isLoading  } = props, restProps = _objectWithoutProperties(props, [
        "isError",
        "isLoading"
    ]);
    return /*#__PURE__*/ jsx("a", _objectSpread({}, restProps, {
        id: "dsqjs-load-more",
...
function DisqusJSPostItem(props) {
    ...
    return /*#__PURE__*/ jsxs("li", {
        ...
        children: [
                        ...
                        children: [
                            /*#__PURE__*/ jsxs("div", {
                                ...
                                children: [
                                    ...
                                    props.admin === props.username && /*#__PURE__*/ jsx("span", {
            ...
            /*#__PURE__*/ jsx(DisqusJSChildrenPostItems, _objectSpread({}, props, {
...
function DisqusJSChildrenPostItems(props) {
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: props.children.map((comment)=>/*#__PURE__*/ createElement(DisqusJSPostItem, _objectSpread({}, comment, {
                admin: props.admin,
...
const DisqusJSCommentsList = (props)=>{
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: processedComments.map((comment)=>/*#__PURE__*/ createElement(DisqusJSPostItem, _objectSpread({}, comment, {
                key: comment.comment.id,
                admin: props.admin,
                adminLabel: props.adminLabel
            }))
...
const DisqusJSSortTypeRadio = /*#__PURE__*/ memo(()=>{
...
const DisqusJSPosts = (props)=>{
    const apiKeys = useMemo(()=>Array.isArray(props.apikey) ? props.apikey : [
            props.apikey
        ]
    , [
        props.apikey
    ...
    const fetchNextPageOfPosts = useCallback(()=>fetchMorePosts(props.shortname, props.id, apiKeys, props.api)
    , [
        apiKeys,
        fetchMorePosts,
        props.api,
    ...
    if (thread.response.length === 1) {
        ...
        return /*#__PURE__*/ jsxs(Fragment, {
            children: [
                ...
                /*#__PURE__*/ jsx(DisqusJSPosts, _objectSpread({}, props, {
...
var DisqusJS = /*#__PURE__*/ forwardRef((props, ref)=>{
