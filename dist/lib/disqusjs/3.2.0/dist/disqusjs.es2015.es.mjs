...
function DisqusJSChildrenPostItems({ children, nesting: currentNesting = 1 }) {
    ...
    return /*#__PURE__*/ u("ul", {
        ...
        children: children.map((comment)=>/*#__PURE__*/ u(DisqusJSPostItem, _object_spread({}, comment), comment.comment.id))
    });
}
...
function DisqusJSCommentsList({ comments }) {
    ...
    return /*#__PURE__*/ u("ul", {
        ...
        children: processedComments.map((comment)=>/*#__PURE__*/ u(DisqusJSPostItem, _object_spread({}, comment), comment.comment.id))
    });
}
...
class DisqusJS {
    render(el) {
        ...
        if (container) {
            ...
            G$1(/*#__PURE__*/ u(DisqusJS$1, _object_spread({}, this.config)), container);
        }
    }
    destroy() {
        if (this.container) {
