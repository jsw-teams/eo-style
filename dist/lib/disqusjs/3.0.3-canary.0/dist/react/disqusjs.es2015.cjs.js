...
const DisqusJSPosts = ({ id })=>{
    ...
    const [errorWhenLoadMorePosts, setErrorWhenLoadingMorePosts] = react.useState(false);
    ...
    const comments = react.useMemo(()=>posts.filter(Boolean).map((i)=>i.response).flat(), [
        posts
    ]);
    if (posts.length > 0) {
        var _posts_;
...
const DisqusJS = /*#__PURE__*/ react.forwardRef((_param, ref)=>{
    ...
    if (useIsClient.useIsClient()) {
        return /*#__PURE__*/ jsxRuntime.jsx("div", _object_spread_props(_object_spread({
            ...
            children: /*#__PURE__*/ jsxRuntime.jsx(ConfigProvider, {
                value: {
                    shortname,
                    siteName,
                    identifier,
                ...
                children: /*#__PURE__*/ jsxRuntime.jsx(ModeProvider, {
                    children: /*#__PURE__*/ jsxRuntime.jsx(SortTypeProvider, {
                        children: /*#__PURE__*/ jsxRuntime.jsx(HasErrorProvider, {
                            children: /*#__PURE__*/ jsxRuntime.jsx(MessageProvider, {
