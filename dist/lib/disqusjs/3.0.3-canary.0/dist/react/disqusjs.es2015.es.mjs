...
const DisqusJSLoadMoreCommentsButton = /*#__PURE__*/ memo((_param)=>{
    ...
    return /*#__PURE__*/ jsx("a", _object_spread_props(_object_spread({}, restProps), {
        id: "dsqjs-load-more",
...
function DisqusJSChildrenPostItems({ children, nesting: currentNesting = 1 }) {
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: children.map((comment)=>/*#__PURE__*/ createElement(DisqusJSPostItem, _object_spread_props(_object_spread({}, comment), {
...
const DisqusJSCommentsList = ({ comments })=>{
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: processedComments.map((comment)=>/*#__PURE__*/ createElement(DisqusJSPostItem, _object_spread_props(_object_spread({}, comment), {
                key: comment.comment.id
            })))
    });
};
...
const DisqusJSPosts = ({ id })=>{
    ...
    const fetchMorePosts = useCallback(/*#__PURE__*/ _async_to_generator(function*(reset = false) {
        var _lastPost;
        if (!id) return;
    ...
    const comments = useMemo(()=>posts.filter(Boolean).map((i)=>i.response).flat(), [
        posts
    ]);
    if (posts.length > 0) {
        var _posts_;
        return /*#__PURE__*/ jsxs(Fragment, {
            children: [
                ...
                ((_posts_ = posts[posts.length - 1]) === null || _posts_ === void 0 ? void 0 : _posts_.cursor.hasNext) && /*#__PURE__*/ jsx(DisqusJSLoadMoreCommentsButton, {
...
const DisqusJSThread = ()=>{
    ...
    const fetchThread = useCallback(/*#__PURE__*/ _async_to_generator(function*() {
        try {
...
const DisqusJS = /*#__PURE__*/ forwardRef((_param, ref)=>{
    ...
    if (useIsClient()) {
        return /*#__PURE__*/ jsx("div", _object_spread_props(_object_spread({
            ref: ref
        }, rest), {
            ...
            children: /*#__PURE__*/ jsx(ConfigProvider, {
                ...
                children: /*#__PURE__*/ jsx(ModeProvider, {
                    children: /*#__PURE__*/ jsx(SortTypeProvider, {
                        children: /*#__PURE__*/ jsx(HasErrorProvider, {
