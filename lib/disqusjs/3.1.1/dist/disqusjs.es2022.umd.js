(function (global, factory) {
  ...
  function DisqusJSChildrenPostItems({ children, nesting: currentNesting = 1 }) {
      ...
      return /*#__PURE__*/ u("ul", {
          ...
          children: children.map((comment)=>/*#__PURE__*/ _$1(DisqusJSPostItem, {
                  ...comment,
  ...
  function DisqusJSCommentsList({ comments }) {
      ...
      return /*#__PURE__*/ u("ul", {
          ...
          children: processedComments.map((comment)=>/*#__PURE__*/ _$1(DisqusJSPostItem, {
                  ...comment,
                  key: comment.comment.id
              }))
      });
  ...
  const DisqusJS$1 = /*#__PURE__*/ D(({ shortname, siteName, identifier, url, title, api, apikey, nesting, nocomment, admin, adminLabel, className, ...rest }, ref)=>{
      const contexts = T$1(()=>[
