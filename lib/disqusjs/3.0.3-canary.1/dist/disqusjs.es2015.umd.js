(function (global, factory) {
    ...
    let r$1=()=>{let[r,l]=h(!1);return p(()=>{l(!0);},[]),r};

    let r=r=>{let{contexts:t,children:o}=r;return t.reduceRight((r,t)=>sn(t,{children:r}),o)};
    ...
    const DisqusJSLoadMoreCommentsButton = /*#__PURE__*/ x((_param)=>{
        ...
        return /*#__PURE__*/ o$1("a", _object_spread_props(_object_spread({}, restProps), {
            id: "dsqjs-load-more",
    ...
    function DisqusJSChildrenPostItems({ children, nesting: currentNesting = 1 }) {
        ...
        return /*#__PURE__*/ o$1("ul", {
            ...
            children: children.map((comment)=>/*#__PURE__*/ y(DisqusJSPostItem, _object_spread_props(_object_spread({}, comment), {
    ...
    const DisqusJSCommentsList = ({ comments })=>{
        ...
        return /*#__PURE__*/ o$1("ul", {
            ...
            children: processedComments.map((comment)=>/*#__PURE__*/ y(DisqusJSPostItem, _object_spread_props(_object_spread({}, comment), {
                    key: comment.comment.id
                })))
        });
    };
    ...
    const DisqusJSPosts = ({ id })=>{
        ...
        const fetchMorePosts = T$1(/*#__PURE__*/ _async_to_generator(function*(reset = false) {
            var _lastPost;
            if (!id) return;
            ...
            const url = `${api}3.0/threads/listPostsThreaded?forum=${shortname}&thread=${id}&order=${sortType !== null && sortType !== void 0 ? sortType : 'desc'}${posts.length !== 0 && ((_lastPost = lastPost) === null || _lastPost === void 0 ? void 0 : _lastPost.cursor.next) ? `&cursor=${encodeURIComponent(lastPost.cursor.next)}` : ''}`;
            const handleError = ()=>{
                if (reset) {
                    setError(true);
        ...
        if (posts.length > 0) {
            ...
            return /*#__PURE__*/ o$1(k$2, {
                children: [
                    ...
                    ((_posts_ = posts[posts.length - 1]) === null || _posts_ === void 0 ? void 0 : _posts_.cursor.hasNext) && /*#__PURE__*/ o$1(DisqusJSLoadMoreCommentsButton, {
    ...
    const DisqusJSThread = ()=>{
        ...
        const setError = useSetHasError();
        const identifier = $identifier !== null && $identifier !== void 0 ? $identifier : document.location.origin + document.location.pathname + document.location.search;
        const fetchThread = T$1(/*#__PURE__*/ _async_to_generator(function*() {
            try {
    ...
    const DisqusJS$1 = /*#__PURE__*/ k((_param, ref)=>{
        ...
        if (r$1()) {
            return /*#__PURE__*/ o$1("div", _object_spread_props(_object_spread({
                ref: ref
            }, rest), {
                className: `${styles.dsqjs} ${className !== null && className !== void 0 ? className : ''}`,
                children: /*#__PURE__*/ o$1(r, {
                    contexts: [
                        /*#__PURE__*/ o$1(ConfigProvider, {
                            value: {
                                shortname,
                                siteName,
                                identifier,
                        ...
                        /*#__PURE__*/ o$1(ModeProvider, {}),
                        /*#__PURE__*/ o$1(SortTypeProvider, {}),
                        /*#__PURE__*/ o$1(HasErrorProvider, {}),
                        /*#__PURE__*/ o$1(MessageProvider, {})
                    ],
    ...
    class DisqusJS {
        render(el) {
            ...
            if (container) {
                ...
                D$1(/*#__PURE__*/ o$1(DisqusJS$1, _object_spread({}, this.config)), container);
            }
        }
        destroy() {
            if (this.container) {
