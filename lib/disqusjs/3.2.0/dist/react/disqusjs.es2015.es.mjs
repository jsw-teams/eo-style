...
import { memo, useCallback, useMemo, useState, useEffect, createContext, useContext, useRef, forwardRef } from 'react';
...
function DisqusJSChildrenPostItems({ children, nesting: currentNesting = 1 }) {
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: children.map((comment)=>/*#__PURE__*/ jsx(DisqusJSPostItem, _object_spread({}, comment), comment.comment.id))
    });
}
...
function DisqusJSCommentsList({ comments }) {
    ...
    return /*#__PURE__*/ jsx("ul", {
        ...
        children: processedComments.map((comment)=>/*#__PURE__*/ jsx(DisqusJSPostItem, _object_spread({}, comment), comment.comment.id))
    });
}
...
function DisqusJSPosts({ id }) {
    ...
    const fetchMorePosts = useCallback((reset = false)=>_async_to_generator(function*() {
            if (!id) return;
...
function DisqusJSThread() {
    ...
    const fetchThread = useCallback(()=>_async_to_generator(function*() {
            try {
