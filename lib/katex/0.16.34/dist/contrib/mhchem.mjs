...
makeEm(fontMetricsData['Main-Regular']["T".charCodeAt(0)][1] -
...
requireUnicodeAccents();

var unicodeSymbols;
var hasRequiredUnicodeSymbols;
function requireUnicodeSymbols() {
  if (hasRequiredUnicodeSymbols) return unicodeSymbols;
  ...
  unicodeSymbols = result;
  return unicodeSymbols;
}

requireUnicodeSymbols();
